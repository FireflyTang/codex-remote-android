...
第一版个人 Demo 可从 [GitHub Release v0.1.0](https://github.com/FireflyTang/codex-remote-android/releases/tag/v0.1.0)
下载 `codex-remote-android-v0.1.0-debug.apk`，或使用
[APK 直链](https://github.com/FireflyTang/codex-remote-android/releases/download/v0.1.0/codex-remote-android-v0.1.0-debug.apk)。
